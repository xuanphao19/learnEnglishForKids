...
(function (global, factory) {
  ...
  var CurrentTimeDisplay = (function (_Component) {
    ...
    CurrentTimeDisplay.prototype.updateTextNode_ = function updateTextNode_() {
      ...
      this.textNode_ = document_1.createTextNode(
  ...
  var RemainingTimeDisplay = (function (_Component) {
    ...
    RemainingTimeDisplay.prototype.updateTextNode_ =
      function updateTextNode_() {
        if (this.textNode_) {
          this.contentEl_.removeChild(this.textNode_);
        }
        this.textNode_ = document_1.createTextNode(
  ...
  var TextTrackMenuItem = (function (_MenuItem) {
    ...
    function TextTrackMenuItem(player, options) {
      ...
      var selectedLanguageChangeHandler = bind(
        _this,
        _this.handleSelectedLanguageChange
      );
  ...
  var Player = (function (_Component) {
    ...
    Player.prototype.selectSource = function selectSource(sources) {
      ...
      var finder = function finder(_ref2, source) {
        ...
        if (
          tech.canPlaySource(source, _this5.options_[techName.toLowerCase()])
        ) {
...
!(function () {
  !(function (a) {
    var b = a && a.videojs;
    b && (b.CDN_VERSION = "6.2.7");
  })(window),
    (function (a, b, c, d, e, f, g) {
      b &&
        !1 !== b.HELP_IMPROVE_VIDEOJS &&
        (e.random() > 0.01 ||
          ((f = b.location),
          (g = b.videojs || {}),
          (a.src =
